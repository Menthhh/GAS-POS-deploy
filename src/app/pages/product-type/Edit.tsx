...
const ProductTypeEditForm = ({
    ...
    const handleSubmit = async (e: any) => {
        ...
        const body = {
            productTypeId: editData?.PT_ID,
            productType: e.target.productType.value,
        };
        try {
            const response = await fetch("/api/update-product-type", {
                method: "PUT",
                headers: {
